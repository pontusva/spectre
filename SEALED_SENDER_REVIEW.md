...
2. **H3 + H4** are the recommended construction hardening (move public keys into the KDF IKM; add an in-AEAD transcript commitment) — design decisions we deliberately did NOT apply unilaterally; they want your sign-off.
